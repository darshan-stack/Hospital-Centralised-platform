...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const hospitalDoc = await getDoc(doc(db, 'hospitals', userCredential.user.uid));
      ...
      if (hospitalDoc.exists()) {
        ...
        localStorage.setItem('hospitalCity', hospitalData.city);
        localStorage.setItem('hospitalContact', hospitalData.contact);
